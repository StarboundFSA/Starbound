    ...
    <>
      ...
      <div className={styles.desPlnts}>
        <div className={styles.desPlntsText}>
          <h2 className={styles.desPlntsHead}>MERCURY</h2>
          <p>
          ...
          <h2 className={styles.desPlntsBttn} >
            <Link href={"/bookings"}>BOOK A FlIGHT RIGHT NOW! <BsFillRocketTakeoffFill/> </Link>
          </h2>
        </div>
        <div>
      ...
      <div className={styles.desPlnts}>
        <div className={styles.desPlntsText}>
          <h2 className={styles.desPlntsHead} >VENUS</h2>
          <p>
      ...
      <div className={styles.desPlnts}>
        <div className={styles.desPlntsText}>
          <h2 className={styles.desPlntsHead} >MARS</h2>
          <p>
      ...
      <div className={styles.desPlnts}>
        <div className={styles.desPlntsText}>
          <h2 className={styles.desPlntsHead} >JUPITER</h2>
          <p>
      ...
      <div className={styles.desPlnts}>
        <div className={styles.desPlntsText}>
          <h2 className={styles.desPlntsHead} >SATURN</h2>
          <p>
      ...
      <div className={styles.desPlnts}>
        <div className={styles.desPlntsText}>
          <h2 className={styles.desPlntsHead} >URANUS</h2>
          <p>
      ...
      <div className={styles.desPlnts}>
        <div className={styles.desPlntsText}>
          <h2 className={styles.desPlntsHead} >NEPTUNE</h2>
          <p>
