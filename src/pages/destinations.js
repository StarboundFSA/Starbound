...
const Destinations = () => {
  return (
    <>
      <h1 className={styles.desHead}>DESTINATIONS</h1>
      <div className={styles.desScroll}>
        <div className={styles.desPlnts}>
          <div className={styles.desPlntsText}>
            ...
            <p>
              ...
              That title belongs to nearby Venus, thanks to its dense
              atmosphere.
            </p>
            <p>
        ...
        <div className={styles.desPlnts}>
          <div className={styles.desPlntsText}>
            ...
            <p>
              ...
              hottest planet in our solar system, even though Mercury is closer
              to the Sun. Surface temperatures on Venus are about 900 degrees
        ...
        <div className={styles.desPlnts}>
          <div className={styles.desPlntsText}>
            ...
            <p>
              An international fleet of eight orbiters is studying the Red
              Planet from above including three NASA orbiters: 2001 Mars
              Odyssey, Mars Reconnaissance Orbiter, and MAVEN.
            </p>
            <p>
              These robotic explorers have found lots of evidence that Mars was
              much wetter and warmer, with a thicker atmosphere, billions of
              years ago.
            </p>
            <h2 className={styles.desBttn}>
              <Link href={"/bookings"}>BOOK A FlIGHT RIGHT NOW!</Link>
        ...
        <div className={styles.desPlnts}>
          <div className={styles.desPlntsText}>
            ...
            <p>
              ...
              among the planets. It is not the only planet to have rings – made
              of chunks of ice and rock – but none are as spectacular or as
        ...
        <div className={styles.desPlnts}>
          <div className={styles.desPlntsText}>
            ...
            <p>
              ...
              planet found with the aid of a telescope, Uranus was discovered in
              1781 by astronomer William Herschel, although he originally
              thought it was either a comet or a star.
            </p>
            <p>
              It was two years later that the object was universally accepted as
              a new planet, in part because of observations by astronomer Johann
